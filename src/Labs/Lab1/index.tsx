...
<div id="wd-lists">
  ...
  How to make pancakes:
  <ol id="wd-pancakes">
    <li>Mix flour, eggs, milk, and sugar in a bowl.</li>
    <li>Heat a pan over medium heat and pour the batter to form pancakes.</li>
    <li>Flip the pancakes when bubbles appear on the surface, then cook the other side until golden brown.</li>
  </ol>
  My favorite recipe:
  <ol id="wd-my-favorite-recipe">
    <li>Preheat the oven to 375°F (190°C).</li>
    <li>Mix the dry ingredients: flour, sugar, and baking powder in a large bowl.</li>
    <li>Add the wet ingredients: milk, eggs, and butter, then stir until the mixture is smooth and pour it into a baking dish. Bake for 30 minutes until golden brown.</li>
  </ol>
...
Also, check out my code repository on GitHub:
<a href="https://github.com/katerinex/kambaz-react-web-app" id="wd-github">My GitHub Repository</a>
    </div>
